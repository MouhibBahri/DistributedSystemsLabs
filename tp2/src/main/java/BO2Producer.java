...
public class BO2Producer {
    private final static String QUEUE_NAME = "BO2_to_HO";

    public static void main(String[] argv) throws Exception {
        // Connect to MySQL (BO2_DB)
        Connection mysqlConnection = DriverManager.getConnection("jdbc:mysql://localhost:3306/BO2_DB", "root", "");
